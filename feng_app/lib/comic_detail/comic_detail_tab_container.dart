...
import 'package:fengapp/comic_detail/comic_detail_tab_one.dart';
import 'package:fengapp/comic_detail/comic_detail_tab_three.dart';
import 'package:fengapp/comic_detail/comic_detail_tab_two.dart';
import 'package:fengapp/public.dart';

class ComicDetailTabContainer extends StatefulWidget {
  final TabController tabController;

  ComicDetailTabContainer({Key key, @required this.tabController})
      : super(key: key);
